...
function h1_customize_preview_js() {
	wp_enqueue_script( 'h1_customizer', get_template_directory_uri() . '/assets/js/dev/wp/customizer.js', array( 'customize-preview' ), '20130508', true );
}
